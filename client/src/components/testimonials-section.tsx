...
export default function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      content: "So l was like, literally just sitting here, like, bashing my head against the wall at my class... So then that's why I started using Thetawise & was like yea this is super helpful for me.",
      color: "bg-green-500",
    },
    {
      icon: Star,
    ...
    },
    {
      ...
      content: "Before Thetawise I'd get an answer wrong and be like, why the **** is this? I don't understand... But now I'm like 'ok, bet', 'cause if that happens now, Thetawise can explain why to me.",
      color: "bg-orange-500",
    },
    {
      icon: FlaskConical,
      name: "PhD Student",
      role: "UC Berkeley",
      content: "I tried a bunch of other AIs that just weren't accurate so at that point I just didn't know what to do... I asked one of my upperclassmen friends and she said I should try Thetawise and like I would have been so screwed without that.",
      color: "bg-red-500",
    },
    {
      icon: TrendingUp,
      name: "chad_killa",
      role: "Twitter User",
      content: "@thetawise fixed my life",
      color: "bg-indigo-500",
    },
  ];
